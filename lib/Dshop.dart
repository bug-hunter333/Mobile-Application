      ...
      child: Column(
        children: [
          ...
          _buildDetailItem(
            ...
            widget.product['quantity'] > 5 ? Colors.green : Colors.red,
          ),
        ],
      ),
    );
        ...
        children: [
          ...
          Row(
            children: [
              ...
              IconButton(
                onPressed: selectedQuantity < (widget.product['quantity'] ?? 0)
                    ? () => setState(() => selectedQuantity++)
                    : null,
...
Widget _buildPurchaseSection() {
  final isOutOfStock = (widget.product['quantity'] ?? 0) == 0;
...
void _addToCart() async {
  ...
  // Move the following methods inside _ShopPageState
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color.fromARGB(255, 14, 129, 83),
                foregroundColor: Colors.white,
              ),
...
// Your existing Dumbellspage class remains the same
// Just make sure to import this ShopPage at the top of your main file:
// import 'lib/Dshop.dart';