...
class Yogamatspage extends StatefulWidget {
  const Yogamatspage({super.key});

  @override
  State<Yogamatspage> createState() => _YogamatspageState();
}

class _YogamatspageState extends State<Yogamatspage> 
    with TickerProviderStateMixin {
  List<dynamic> yogaProducts = [];
  ...
  final List<String> categories = ['All', 'Yoga Mats', 'Exercise Mats', 'Pilates Mats'];
  ...
  void loadData() async {
    try {
      List<dynamic> data = await loadyogaData();
      setState(() {
        yogaProducts = data;
  ...
  Future<List<dynamic>> loadyogaData() async {
    try {
      String jsonString = await rootBundle.loadString('assets/yoga.json');
  ...
  void _filterProducts() {
    setState(() {
      filteredProducts = yogaProducts.where((product) {
          ...
          children: [
            ...
            Text(
              searchQuery.isNotEmpty 
                  ...
                  : 'Please check if Yoga.json exists in assets folder',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 16,
