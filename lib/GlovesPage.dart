...
class _GlovespageState extends State<Glovespage> 
  ...
  final List<String> categories = ['All', 'Mesh Gloves', 'Leather Gloves', 'Weightlifting Gloves', 'CrossFit Gloves'];
  ...
  void loadData() async {
    try {
      List<dynamic> data = await loadGloveData();
      setState(() {
        gloveProducts = data;
  ...
  Future<List<dynamic>> loadGloveData() async {
    try {
      String jsonString = await rootBundle.loadString('assets/glove.json');
      List<dynamic> jsonData = json.decode(jsonString);
      return jsonData;
    } catch (e) {
      print('Error loading glove data: $e');
      throw e;
    }
  }
  ...
  void _filterProducts() {
    setState(() {
      filteredProducts = gloveProducts.where((product) {
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search Weighlifting Gloves ',
          ...
          children: [
            ...
            Text(
              searchQuery.isNotEmpty 
                  ...
                  : 'Please check if glove.json exists in assets folder',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 16,
